              ...
              <div className="anuncio-card" key={idx}>
                ...
                <div className="anuncio-info">
                  ...
                  <div className="anuncio-footer">
                    ...
                    <span className="anuncio-nota">
                      <span role="img" aria-label="estrela">⭐</span> {anuncio.nota} <span className="anuncio-reviews">({anuncio.reviews})</span>
                    </span>
                    <button className="anuncio-btn">Saiba Mais</button>
                  </div>
                </div>
              </div>
            ))}
