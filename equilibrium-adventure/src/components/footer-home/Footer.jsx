        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul>
              ...
              <li><a href="#contato" onClick={(e) => handleLinkClick(e, 'contato')}>Entre em Contato</a></li>
              <li><a href="#termos" onClick={(e) => handleLinkClick(e, 'termos')}>Termos de Uso</a></li>
              <li><a href="#privacidade" onClick={(e) => handleLinkClick(e, 'privacidade')}>Política de Privacidade</a></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>
                ...
                <a href="mailto:contato@equilibriumadventure.com">contato@equilibriumadventure.com</a>
              </li>
              <li>
                <span className="contact-icon">📱</span>
