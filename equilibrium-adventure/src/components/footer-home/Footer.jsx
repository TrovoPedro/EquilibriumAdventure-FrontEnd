...
export default function Footer() {
  ...
  const toggleSection = (sectionId) => {
    if (!isMobile) return; // apenas mobile ativa o accordion
    ...
    <footer className="main-footer">
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className={`footer-section footer-brand ${openSection === 'brand' ? 'open' : ''}`}>
            {isMobile ? (
          ...
          {!isMobile && (
            <div className={`footer-section ${openSection === 'nav' ? 'open' : ''}`}>
              <h4>Navegação</h4>
              <div className="section-body">
                <ul>
                  <li>
          ...
          <div className={`footer-section ${openSection === 'support' ? 'open' : ''}`}>
            {isMobile ? (
              <div className="section-header">
                <h4>Suporte</h4>
                <button
            ...
            <div className="section-body">
              <ul>
                ...
                <li>
                  <a href="/Termos de Uso.pdf" download="Termos-de-Uso.pdf" target="_blank">Termos de Uso</a>
                </li>
                <li>
                  <a href="/Politica-de-Privacidade.pdf" download="Politica-de-Privacidade.pdf" target="_blank">Política de Privacidade</a>
                </li>
              </ul>
            </div>
          </div>
